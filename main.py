...
if __name__ == '__main__':
    ...
    while True:
        print()
        print_center("==============================")
        print_center(colored("1 - Kanishk Pachauri - XII B - ROLL NO: 18","green","on_blue"))
        print_center(colored("1 - Prince Rajput - XII B - ROLL NO: 32","green","on_blue"))
        print_center("==============================")
        print_center("=====Sillicon Vally California Hotel U.S.A=====")
        print_center("==============================")
